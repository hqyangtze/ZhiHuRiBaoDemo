...
#define IPHONE_X      (MAX(SCREEN_HEIGHT,SCREEN_WIDTH) == 812.0)
#define SAFEAREA_BOTTOM  (IPHONE_X?34.0f:0.0f)
#define STATUSBAR_HEIGHT (IPHONE_X?44.0f:20.0f)
#define NAVIGATION_HEIGHT (44.0)
#define TABBAR_HEIGHT   (IPHONE_X?(SAFEAREA_BOTTOM+49.0f):49.0f)
#define TOOLBAR_HEIGHT  (IPHONE_X?(SAFEAREA_BOTTOM+44.0f):44.0f)
